...
enum class Consumables {
    ...
    ASGARNIAN_ALE_M(Drink(intArrayOf(Items.ASGARNIAN_ALEM_5739, Items.BEER_GLASS_1919), MultiEffect(SkillEffect(Skills.STRENGTH, 3.0, 0.0), SkillEffect(Skills.ATTACK, -6.0, 0.0)), "You drink the ale. You feel slightly reinvigorated...", "...and slightly dizzy too.")),
    ASGARNIAN_ALE_M_KEG(Drink(intArrayOf(Items.ASGARNIAN_ALEM4_5865, Items.ASGARNIAN_ALEM3_5863, Items.ASGARNIAN_ALEM2_5861, Items.ASGARNIAN_ALEM1_5859, Items.CALQUAT_KEG_5769), MultiEffect(SkillEffect(Skills.STRENGTH, 3.0, 0.0), SkillEffect(Skills.ATTACK, -6.0, 0.0)), Animation(2289), "You drink the ale. You feel slightly reinvigorated...", "...and slightly dizzy too.")),
    ...
    DWARVEN_STOUT_M(Drink(intArrayOf(Items.DWARVEN_STOUTM_5747, Items.BEER_GLASS_1919), MultiEffect(SkillEffect(Skills.MINING, 2.0, 0.0), SkillEffect(Skills.SMITHING, 2.0, 0.0), SkillEffect(Skills.ATTACK, -7.0, 0.0), SkillEffect(Skills.STRENGTH, -7.0, 0.0), SkillEffect(Skills.DEFENCE, -7.0, 0.0), HealingEffect(1)), "You drink the Dwarven Stout. It tastes foul.", "It tastes pretty strong too.")),
    DWARVEN_STOUT_M_KEG(Drink(intArrayOf(Items.DWARVEN_STOUTM4_5857, Items.DWARVEN_STOUTM3_5855, Items.DWARVEN_STOUTM2_5853, Items.DWARVEN_STOUTM1_5851, Items.CALQUAT_KEG_5769), MultiEffect(SkillEffect(Skills.MINING, 2.0, 0.0), SkillEffect(Skills.SMITHING, 2.0, 0.0), SkillEffect(Skills.ATTACK, -7.0, 0.0), SkillEffect(Skills.STRENGTH, -7.0, 0.0), SkillEffect(Skills.DEFENCE, -7.0, 0.0), HealingEffect(1)), Animation(2289), "You drink the Dwarven Stout. It tastes foul.", "It tastes pretty strong too.")),
    ...
    MOONLIGHT_MEAD(Drink(intArrayOf(Items.MOONLIGHT_MEAD_2955, Items.BEER_GLASS_1919), HealingEffect(5), "It tastes like something just died in your mouth.")),
    MOONLIGHT_MEAD_KEG(Drink(intArrayOf(Items.MOONLIGHT_MEAD4_5817, Items.MOONLIGHT_MEAD3_5815, Items.MOONLIGHT_MEAD2_5813, Items.MOONLIGHT_MEAD1_5811, Items.CALQUAT_KEG_5769), HealingEffect(5), Animation(2289), "It tastes like something just died in your mouth.")),
    MOONLIGHT_MEAD_M(Drink(intArrayOf(Items.MOONLIGHT_MEADM_5749, Items.BEER_GLASS_1919), HealingEffect(6), "It tastes like something just died in your mouth.")),
    MOONLIGHT_MEAD_M_KEG(Drink(intArrayOf(Items.MLIGHT_MEADM4_5897, Items.MLIGHT_MEADM3_5895, Items.MLIGHT_MEADM2_5893, Items.MLIGHT_MEADM1_5891, Items.CALQUAT_KEG_5769), HealingEffect(4), Animation(2289), "It tastes like something just died in your mouth.")),
    ...
    WIZARDS_MIND_BOMB_KEG(Drink(intArrayOf(Items.MIND_BOMB4_5801, Items.MIND_BOMB3_5799, Items.MIND_BOMB2_5797, Items.MIND_BOMB1_5795, Items.CALQUAT_KEG_5769), WizardsMindBombEffect(), Animation(2289), "You drink the Wizard's Mind Bomb.", "You feel very strange.")),
    MATURE_WMB(Drink(intArrayOf(Items.MATURE_WMB_5741, Items.BEER_GLASS_1919), MatureWmbEffect(), "You drink the mature Wizard's Mind Bomb.", "You feel very strange.")),
    MATURE_WMB_KEG(Drink(intArrayOf(Items.MIND_BOMBM4_5881, Items.MIND_BOMBM3_5879, Items.MIND_BOMBM2_5877, Items.MIND_BOMBM1_5875, Items.CALQUAT_KEG_5769), MatureWmbEffect(), Animation(2289), "You drink the mature Wizard's Mind Bomb.", "You feel very strange.")),
