...
class EmptyOptionPlugin: InteractionListener {
    ...
    enum class EmptyItem(var fullId: Int, var emptyId: Int, var emptyMessage: String, var audioId: Int = -1) {
        ...
        FISHBOWL(Items.FISHBOWL_6668, Items.FISHBOWL_6667, "You pour out the contents of your fishbowl."),
        FISHBOWL_WITH_SEAWEED(Items.FISHBOWL_6669, Items.FISHBOWL_6667, "You pour out the contents of your fishbowl."),
        FIREWORK(Items.FIREWORK_3006, Items.VIAL_229, "You empty the vial.", Sounds.LIQUID_2401),
        VIAL_OF_COCONUT(Items.COCONUT_MILK_5935, Items.VIAL_229, "You empty the vial.", Sounds.LIQUID_2401),
        SANDBAG(Items.SANDBAG_9943, Items.EMPTY_SACK_5418, "You empty the sack of sand."),
        VIAL_OF_WATER(Items.VIAL_OF_WATER_227, Items.VIAL_229, "You empty the vial.", Sounds.LIQUID_2401),
        GOLD_BOWL(Items.GOLDEN_BOWL_723, Items.GOLD_BOWL_721, "You empty the contents of the bowl onto the floor."),
        BLESSED_GOLDEN_BOWL(Items.GOLDEN_BOWL_724, Items.BLESSED_GOLD_BOWL_722, "You empty the contents of the bowl onto the floor."),
        GOLDEN_BOWL(Items.GOLDEN_BOWL_725, Items.GOLD_BOWL_721, "You empty the contents of the bowl onto the floor."),
        GOLDEN_BOWL_2(Items.GOLDEN_BOWL_726, Items.GOLD_BOWL_721, "You empty the contents of the bowl onto the floor."),
        ;
