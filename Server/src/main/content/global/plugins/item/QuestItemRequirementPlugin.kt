...
class QuestItemRequirementPlugin : InteractionListener {
    ...
    private val godBooks = intArrayOf(Items.UNHOLY_BOOK_3842,Items.BOOK_OF_BALANCE_3844,Items.DAMAGED_BOOK_3839,Items.DAMAGED_BOOK_3841,Items.DAMAGED_BOOK_3843)
