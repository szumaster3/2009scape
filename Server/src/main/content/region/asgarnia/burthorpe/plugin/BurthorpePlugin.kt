package content.region.asgarnia.burthorpe.plugin

import content.region.asgarnia.burthorpe.dialogue.*
import core.api.*
...
class BurthorpePlugin : InteractionListener {
    ...
    companion object {
        ...
        private val BURTHORPE_NPC_IDS = intArrayOf(NPCs.BREOCA_1084, NPCs.BERNALD_2580, NPCs.CEOLBURG_1089, NPCs.OCGA_1085, NPCs.HILD_1090, NPCs.HYGD_1088)
    }
    ...
    override fun defineListeners() {
        ...
        on(BURTHORPE_NPC_IDS, IntType.NPC, "talk-to") { player, node ->
            openDialogue(player, BurthorpeNPCDialogue(), node)
            return@on true
        }
