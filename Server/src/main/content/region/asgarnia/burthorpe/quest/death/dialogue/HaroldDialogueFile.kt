        ...
        when (getQuestStage(player!!, Quests.DEATH_PLATEAU)) {
            ...
            13 -> {
                when (stage) {
                    ...
                    10 -> npcl(FaceAnim.FRIENDLY, "I honestly don't know! I've looked everywhere. I've searched the castle and my room!").also { stage++ }
                    11 -> playerl(FaceAnim.ASKING, "Have you tried looking between here and the castle?").also { stage++ }
                    ...
                    20 -> npcl(FaceAnim.FRIENDLY, "Sounds good! I normally drink Asgarnian Ale but you know what?").also { stage++ }
                    21 -> playerl(FaceAnim.ASKING, "What?").also { stage++ }
                    22 -> npc(FaceAnim.FRIENDLY, "I really fancy one of those Blurberry Specials. I never", "get over to the Gnome Stronghold so I haven't had one", "for ages!").also { stage++ }
                    23 -> {
                    ...
                    24 -> {
                        ...
                        runTask(npc!!, 4) {
                            npc!!.sendChat("Wow!")
                            runTask(npc!!, 4) {
                                visualize(npc!!, Animations.DIZZY_2770, Graphics(80, 96))
                                runTask(npc!!, 6) {
                    ...
                    30 -> npcl(FaceAnim.FRIENDLY, "Good. Good. I have some dice. How much do you want to offer?").also { stage++ }
                    31 -> {
                        sendInputDialogue(player!!, true, "Enter amount:") { value ->
                            ...
                            if (wagerAmount <= 0) {
                                ...
                                npcl(FaceAnim.FRIENDLY, "Woah! Do you think I'm made of money? Max bet is 1000 gold.").also { stage = END_DIALOGUE }
                    ...
                    32 -> npcl(FaceAnim.FRIENDLY, "Don't forget that once I start my roll you can't back out of the bet! If you do you lose your stake!").also { stage++ }
                    33 -> {
                        end()
                        npc!!.isWalks = false
                        ...
                        openInterface(player!!, Components.DEATH_DICE_99)
                        sendString(player!!, player!!.name, Components.DEATH_DICE_99, 6)
                    }
                    ...
                    36 -> {
                        sendItemDialogue(player!!, Items.COINS_6964, "Harold has given you some of your winnings!").also {
                    ...
                    23 -> {
                        sendInputDialogue(player!!, true, "Enter amount:") { value ->
                            ...
                            if (wagerAmount <= 0) {
                                ...
                                npcl(FaceAnim.DRUNK, "Eashy tiger! Max bet ish 1000 coinsh.").also { stage = END_DIALOGUE }
                            } else if (!inInventory(player!!, Items.COINS_995) || amountInInventory(player!!, Items.COINS_995) < value) {
                                sendMessage(player!!, "You do not have that much money!").also { stage = END_DIALOGUE }
                            } else if (removeItem(player!!, Item(Items.COINS_995, value))) {
                                player!!.setAttribute("deathplateau:wager", wagerAmount)
                ...
                when (stage) {
                    ...
                    31 -> {
                        if (!removeItem(player!!, Items.ASGARNIAN_ALE_1905)) {
                            ...
                            sendMessage(player!!, "You give Harold an Asgarnian Ale.")
                            sendItemDialogue(player!!, Items.ASGARNIAN_ALE_1905, "You give Harold an Asgarnian Ale.")
                            animate(npc!!, Animations.EAT_OLD_829)
                            runTask(npc!!, 6) {
                                npcl(FaceAnim.FRIENDLY, "Arrh. That hit the spot!").also {
                                    stage = END_DIALOGUE
