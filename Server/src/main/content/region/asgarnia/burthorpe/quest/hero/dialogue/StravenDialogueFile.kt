...
class StravenDialogueFile : DialogueBuilderFile() {
    override fun create(b: DialogueBuilder) {
        b.onQuestStages(Quests.HEROES_QUEST, 1).playerl("How would I go about getting a Master Thief armband?")
            .npcl("Ooh... tricky stuff. Took me YEARS to get that rank.").npcl(
            ...
            .npcl("Use the secret word 'gherkin' to show you're one of us.").endWith { _, player ->
        ...
        b.onQuestStages(Quests.HEROES_QUEST, 2, 3, 4).playerl("What am I supposed to be doing again?")
            .npcl("You told me you wanted to get a Master thief's armband! Now pay attention.").npcl(
            ...
            .npcl("Use the secret word 'gherkin' to show you're one of us.").end()
        ...
        b.onQuestStages(Quests.HEROES_QUEST, 5).branch { player ->
                ...
                branch.onValue(1).playerl("I have retrieved a candlestick!")
                    ...
                    .linel("Straven hands you a Master Thief armband.").endWith { _, player ->
        ...
        b.onQuestStages(Quests.HEROES_QUEST, 6).playerl("I'm afraid I've lost my master thief's armband.")
            .npcl("Lucky for you I have a spare. Don't lose it again!").endWith { _, player ->
                addItemOrDrop(player, Items.THIEVES_ARMBAND_1579)
            }
    }
}
