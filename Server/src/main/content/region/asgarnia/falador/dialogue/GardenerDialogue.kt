        ...
        when (stage) {
            ...
            2000 -> {
                val advice = arrayOf(
                    ...
                    "You don't have to buy all your plantpots you know, you can make them yourself on a pottery wheel. If you're a good enough ${
                        if (player!!.isMale) {
                            "craftsman"
                        } else {
                            "craftswoman"
                    ...
                    "If you want to make your own sacks and baskets you'll need to use the loom that's near the Farming shop in Falador. If you're a good enough ${
                        if (player!!.isMale) {
                            "craftsman"
                        } else {
                            "craftswoman"
