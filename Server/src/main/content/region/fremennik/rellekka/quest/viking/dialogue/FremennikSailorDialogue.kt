...
class FremennikSailorDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        when {
            ...
            inInventory(player, Items.FREMENNIK_BALLAD_3699, 1) -> {
                playerl(FaceAnim.HAPPY, "You'll be glad to know I have had a love song written just for you by Olaf. So can I have that flower of yours now?")
                stage = 15
            }
            ...
            getAttribute(player, GameAttributes.QUEST_VIKING_SIGMUND_START, false) -> {
                playerl(FaceAnim.ASKING, "I don't suppose you have any idea where I could find a unique flower from across the sea, do you?")
                stage = 1
            }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            25 -> npcl(FaceAnim.HAPPY, "Remember, it's not for me unless it's a love ballad.").also { stage = END_DIALOGUE }
        }
        return true
    }
