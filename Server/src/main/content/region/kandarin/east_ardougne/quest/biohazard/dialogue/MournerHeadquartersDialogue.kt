package content.region.kandarin.east_ardougne.quest.biohazard.dialogue
...
class MournerHeadquartersDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            3 -> npcl(FaceAnim.FRIENDLY, "This is no place for sight-seeing. Don't you know there's been a plague outbreak?").also { stage++ }
