...
private class GripDialogueFile : DialogueBuilderFile() {
    override fun create(b: DialogueBuilder) {
        b.onPredicate { _ -> true }.branch { player ->
            ...
            branch.onValue(1).goto(continuePath)
            branch.onValue(0).playerl("Hi there. I am Hartigen, reporting for duty as your new deputy sir!")
                .npcl("Ah good, at last. You took your time getting here! Now let me see...").npcl(
                    ...
                    branch.onValue(1).playerl("Right here sir!").linel("You hand the ID papers over to Grip.")
                    ...
                    branch.onValue(0).playerl("Oh, dear. I don't have that with me any more.")
                        .npcl("Well, that's no good! Go get them immediately, then report back for duty.").end()
            ...
            optionBuilder.option_playerl("So can I please guard the treasure room please?").npcl(
            ...
            }.playerl("So what do my duties involve?").npcl(
            ...
            ).npcl("me anytime soon!").linel("Grip laughs to himself at the thought.").goto(returnJoin)

            optionBuilder.option_playerl("Well, I'd better sort my new room out.").npcl(
            ...
            optionBuilder.optionIf("Anything I can do now?") { player ->
                return@optionIf getAttribute(player, HeroesQuest.attributeGripSaidDuties, false)
            }.playerl("Anything I can do now?").branch { player ->
                ...
                branch.onValue(1).npcl("Can't think of anything right now.").end()
                ...
                ).linel("Grip hands you a key.").endWith { _, player ->
