...
/**
 * Represents the Ur-Taal dialogue.
 */
@Initializable
class UrtaalDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            6 -> npcl(FaceAnim.OLD_NORMAL, "Please don't be offended by my friend's attitude, surface-dweller. I'm sure you understand why we need to be cautious.").also { stage = END_DIALOGUE }
        }
        return true
    }

    override fun newInstance(player: Player?): Dialogue = UrtaalDialogue(player)

    override fun getIds(): IntArray = intArrayOf(NPCs.UR_TAAL_5772)
}
