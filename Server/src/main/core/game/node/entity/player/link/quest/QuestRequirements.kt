...
open class QuestReq(
    val questReq: QuestRequirements,
    val stageRequired: Int = 100,
) : Requirements {
    override fun evaluate(player: Player): Pair<Boolean, List<Requirements>> {
...
enum class QuestRequirements(
    ...
    TROLL_STRONGHOLD(Quests.DEATH_PLATEAU, QuestReq(DEATH_PLATEAU), SkillReq(Skills.AGILITY, 15, true)),
    ...
    GARDEN(Quests.GARDEN_OF_TRANQUILLITY, QuestReq(FENKENSTRAIN), SkillReq(Skills.FARMING, 25)),
    ...
    MEETING_HISTORY(Quests.MEETING_HISTORY, QuestReq(HISTORY), QuestReq(RESTLESS_GHOST), QuestReq(DRUIDIC_RITUAL), QuestReq(PRIEST)),
    ...
    SOUL_BANE(Quests.A_SOULS_BANE), BONE_MAN_1(Quests.RAG_AND_BONE_MAN), SWAN(Quests.SWAN_SONG, QPReq(100), SkillReq(Skills.MAGIC, 66, true), SkillReq(Skills.COOKING, 62, true), SkillReq(Skills.FISHING, 62, true), SkillReq(Skills.SMITHING, 45, true), SkillReq(Skills.FIREMAKING, 42, true), SkillReq(Skills.CRAFTING, 40, true), QuestReq(FAVOR), QuestReq(GARDEN)),
    ...
    BACK_TO_MY_ROOTS(Quests.BACK_TO_MY_ROOTS, QuestReq(FAVOR), QuestReq(TOTEM), QuestReq(SAND), QuestReq(FAIRYTALE_1), SkillReq(Skills.WOODCUTTING, 72, true), SkillReq(Skills.FIREMAKING, 53), SkillReq(Skills.SLAYER, 59), SkillReq(Skills.AGILITY, 55)),
    ...
    RESORT(Quests.AS_A_FIRST_RESORT, QuestReq(ZOGRE), SkillReq(Skills.HUNTER, 48, true), SkillReq(Skills.FIREMAKING, 51), SkillReq(Skills.WOODCUTTING, 58)),
    ...
    ROCKING_OUT(Quests.ROCKING_OUT, SkillReq(Skills.AGILITY, 60), SkillReq(Skills.CRAFTING, 66), SkillReq(Skills.SMITHING, 69), SkillReq(Skills.THIEVING, 63), QuestReq(BRAIN_ROBBERY)),
}
