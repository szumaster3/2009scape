...
enum class WarningType(val varbit: Int, val component: Int, val buttonId: Int) {
    ...
    SHANTAY_PASS(Vars.VARBIT_CWS_WARNING_10_3860, Components.CWS_WARNING_10_565, 63),
    FAIRY_RING_TO_DORGESH_KAAN(Vars.VARBIT_CWS_WARNING_15_3865, Components.CWS_WARNING_15_578, 59),
    MORT_MYRE(Vars.VARBIT_CWS_WARNING_20_3870, Components.CWS_WARNING_20_580, 61),
    DORGESH_KAAN_CITY_EXIT(Vars.VARBIT_CWS_WARNING_16_3869, Components.CWS_WARNING_16_569, 68),
    RANGING_GUILD(Vars.VARBIT_CWS_WARNING_23_3871, Components.CWS_WARNING_23_564, 70),
    DAGANNOTH_KINGS_LADDER(Vars.VARBIT_CWS_WARNING_1_3851, Components.CWS_WARNING_1_574, 50),
    CONTACT_DUNGEON_LADDER(Vars.VARBIT_CWS_WARNING_2_3852, Components.CWS_WARNING_2_562, 56),
    FALADOR_MOLE_LAIR(Vars.VARBIT_CWS_WARNING_3_3853, Components.CWS_WARNING_3_568, 53),
    STRONGHOLD_OF_SECURITY_LADDERS(Vars.VARBIT_CWS_WARNING_4_3854, Components.CWS_WARNING_4_579, 52),
    WATCHTOWER_SHAMAN_CAVE(Vars.VARBIT_CWS_WARNING_12_3862, Components.CWS_WARNING_12_573, 65),
    LUMBRIDGE_SWAMP_CAVE_ROPE(Vars.VARBIT_CWS_WARNING_17_3863, Components.CWS_WARNING_17_570, 51),
    ...
    OBSERVATORY_STAIRS(Vars.VARBIT_CWS_WARNING_9_3859, Components.CWS_WARNING_9_560, 62),
    LUMBRIDGE_CELLAR(Vars.VARBIT_CWS_WARNING_14_3866, Components.CWS_WARNING_14_567, 60),
    PLAYER_OWNED_HOUSES(Vars.VARBIT_CWS_WARNING_5_3855, Components.CWS_WARNING_5_563, 55),
    ...
    companion object {
        val values = enumValues<WarningType>()
